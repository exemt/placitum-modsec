 ...
 * из своего буфера (MODSEC_DEADLINE_EXCEEDED), чтобы слот занял свежий запрос.
 * Полная очередь живых — drop (MODSEC_QUEUE_LIMIT) или wait до места / дедлайна.
...
const (
	ReasonQueueLimit       = "MODSEC_QUEUE_LIMIT"
	ReasonDeadlineExceeded = "MODSEC_DEADLINE_EXCEEDED"
